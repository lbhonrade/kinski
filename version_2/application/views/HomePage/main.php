	  ...
	  case "admin":?>
			<script type="text/javascript">
				function loadPendingRequests(){
					loadUI('UserController','loadPendingAcctsManager','',{},'.right');
				}
				function manageUserAccts(){
					loadUI('UserController','loadUserAcctsManager','',{},'.right');
				}
			</script>
			<div class="bor">
				<div class="categories">
					...
					<form>
						<input type="button" class="homeButton" value="Manage User Accounts" style="width:100%;" onclick="manageUserAccts();"/>
						...
						<input type="button" class="homeButton" value="Generate Report" style="width:100%;" onclick=""/>
					</form>
				</div>
			</div>
	  <?php break;
