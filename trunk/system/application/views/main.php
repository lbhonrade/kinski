...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	...
	<script type="text/javascript">
		var currentPage=-1;
		var pageBaseURL="";
		var menuLbl=new Array("Home","CAS Student Registry","CAS Shifters and Transferees","Transactions from the<br/>CAS-OCS"),
		    menuBaseDIR=new Array("HomePage","CASStudentRegistry","CASShiftersAndTransferees","TransactionsFromTheCASOCS");
		...
		function loadPage(baseDIR,pageURL,id){
			if(id==currentPage) return;
			//document.getElementById("content").innerHTML="<div class=\"right\" style=\"text-align:center;width:100%;\">Loading . . .</div>";
